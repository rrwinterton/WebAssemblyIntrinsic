/*
Proposed WebAssembly SIMD Instructions 14 March 2019
*/
...
//i8x16 wasm_i8x16_constant(...)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_const(int8_t c15,
...
//i8x16 wasm_i8x16_load(i8x16* mem)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_load(i8x16* mem) {
  return __extension__(i8x16)(*mem);
}

//wasm_i8x16_store(i8x16 *mem, i8x16 a)
static __inline__ void __DEFAULT_FN_ATTRS wasm_i8x16_store(i8x16* mem, i8x16 a) {
  *(i8x16*)mem = a;
  return;
}
...
//int8_t wasm_u8x16_extract_lane(i8x16 a, imm)
...
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_add(i8x16 a,
                                                          i8x16 b) {
  return __extension__(i8x16){a + b};
}

//i16x8 wasm_i16x8_add(i16x8 a i16x8 b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_add(i16x8 a,
                                                          i16x8 b) {
  return __extension__(i16x8){a + b};
}

//i32x4 wasm_i32x4_add(i32x4 a i32x4 b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_add(i32x4 a,
                                                          i32x4 b) {
  return __extension__(i32x4){a + b};
}

//i8x16 wasm_i64x2_add(i8x16 a i8x16 b)
static __inline__ i64x2 __DEFAULT_FN_ATTRS wasm_i64x2_add(i64x2 a,
                                                          i64x2 b) {
  return __extension__(i64x2){a + b};
}

//i8x16 wasm_i8x16_sub(i8x16 a, i8x16 b)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_sub(i8x16 a,
                                                          i8x16 b) {
  return __extension__(i8x16){a - b};
}

//i16x8 wasm_i16x8_sub(i16x8 a i16x8 b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_sub(i16x8 a,
                                                          i16x8 b) {
  return __extension__(i16x8){a - b};
}

//i32x4 wasm_i32x4_sub(i32x4 a i32x4 b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_sub(i32x4 a,
                                                          i32x4 b) {
  return __extension__(i32x4){a - b};
}

//i64x2 wasm_i64x2_sub(i64x2 a i64x2 b)
static __inline__ i64x2 __DEFAULT_FN_ATTRS wasm_i64x2_sub(i64x2 a,
                                                          i64x2 b) {
  return __extension__(i64x2){a - b};
}

//i8x16 wasm_i8x16_mul(i8x16 a i8x16 b)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_mul(i8x16 a,
                                                          i8x16 b) {
  return __extension__(i8x16){a * b};
}

//i16x8 wasm_i16x8_mul(i16x8 a i16x8 b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_mul(i16x8 a,
                                                          i16x8 b) {
  return __extension__(i16x8){a * b};
}

//i32x4 wasm_i32x4_mul(i32x4 a i32x4 b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_mul(i32x4 a,
                                                          i32x4 b) {
  return __extension__(i32x4){a * b};
}

//i64x2 wasm_i64x2_mul(i64x2 a i64x2 b)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i64x2_mul(i64x2 a,
                                                          i64x2 b) {
  return __extension__(i64x2){a * b};
}
...
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_shl(i8x16 a,
                                                          int32_t b) {
  return __extension__(i8x16){a << b};
}

//i16x8 wasm_i16x8_shl(i16x8 a, int32_t b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_shl(i16x8 a,
                                                          int32_t b) {
  return __extension__(i16x8){a << b};
}

//i32x4 wasm_i32x4_shl(i32x4 a, int32_t b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_shl(i32x4 a,
                                                          int32_t b) {
  return __extension__(i32x4){a << b};
}

//i64x2 wasm_i64x2_shl(i64x2 a, int32_t b)
static __inline__ i64x2 __DEFAULT_FN_ATTRS wasm_i64x2_shl(i64x2 a,
                                                          int32_t b) {
  return __extension__(i64x2){a << b};
}

//i8x16 wasm_i8x64_shr(i8x16 a, int32_t b)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_shr(i8x16 a,
                                                            int32_t b) {
  return __extension__(i8x16){a >> b};
}

//u8x16 wasm_u8x16_shr(u8x16 a int32_t b)
static __inline__ u8x16 __DEFAULT_FN_ATTRS wasm_u8x16_shr(u8x16 a,
                                                              int32_t b) {
  return __extension__(u8x16){a >> b};
}

//i16x8 wasm_i16x8_shr(i16x8 a, int32_t b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_shr(i16x8 a,
                                                         int32_t b) {
  return __extension__(i16x8){a >> b};
}

//u16x8 wasm_u16x8_shr(u16x8 a, int32_t b)
static __inline__ u16x8 __DEFAULT_FN_ATTRS wasm_u16x8_shr(u16x8 a,
                                                            int32_t b) {
  return __extension__(u16x8){a >> b};
}

//i32x4 wasm_i32x4_shr(i32x4 a, int32_t b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_shr(i32x4 a,
                                                          int32_t b) {
  return __extension__(i32x4){a >> b};
}

//u32x4 wasm_u32x4_shr(u32x4 a, int32_t b)
static __inline__ u32x4 __DEFAULT_FN_ATTRS wasm_u32x4_shr(u32x4 a,
                                                          int32_t b) {
  return __extension__(u32x4){a >> b};
}

//i64x2 wasm_i64x2_shr(i64x2 a, int32_t b)
static __inline__ i64x2 __DEFAULT_FN_ATTRS wasm_i64x2_shr(i8x16 a,
                                                            int32_t b) {
  return __extension__(i64x2){a >> b};
}

//u64x2 wasm_u64x2_shr_u(u64x2 a, int32_t b)
static __inline__ u64x2 __DEFAULT_FN_ATTRS wasm_u64x2_shr(u64x2 a,
                                                          int32_t b) {
...
#ifdef __wasm_undefined_simd128__
//bool wasm_i8x16_any_true(i8x16 a)
#define wasm_i8x16_any_true(a) (__builtin_wasm_any_true_i64x2(a))
#endif

//i8x16 wasm_i8x16_eq(i8x16 a, i8x16 b)
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_eq(i8x16 a,
                                                         i8x16 b) {
  return __extension__(i8x16){a == b};
}

//i16x8 wasm_i16x8_eq(i16x8 a, i16x8 b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_eq(i16x8 a,
                                                            i16x8 b) {
  return __extension__(i16x8){a == b};
}

//i32x4 wasm_i32x4_eq(i32x4 a, i32x4 b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_eq(i32x4 a,
                                                            i32x4 b) {
  return __extension__(i32x4){a == b};
}

#ifdef __wasm_undefined_simd128__
//f32x4 wasm_f32x4_eq(f32x4 a f32x4 b)
static __inline__ f32x4 __DEFAULT_FN_ATTRS wasm_f32x4_eq(f32x4 a,
                                                            f32x4 b) {
...
static __inline__ f64x2 __DEFAULT_FN_ATTRS wasm_f64x2_eq(f64x2 a,
                                                            f64x2 b) {
...
static __inline__ i8x16 __DEFAULT_FN_ATTRS wasm_i8x16_ne(i8x16 a,
                                                           i8x16 b) {
  return __extension__(i8x16){a != b};
}

//i16x8 wasm_i16x8_ne(i16x8 a, i32x4 b)
static __inline__ i16x8 __DEFAULT_FN_ATTRS wasm_i16x8_ne(i16x8 a,
                                                            i16x8 b) {
  return __extension__(i16x8){a != b};
}

//i32x4 wasm_i32x4_ne(i32x4 a, i32x4 b)
static __inline__ i32x4 __DEFAULT_FN_ATTRS wasm_i32x4_ne(i32x4 a,
                                                            i32x4 b) {
  return __extension__(i32x4){a != b};
}
...
static __inline__ u8x16 wasm_u8x16_lt(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a < b};
}
...
//u16x8 wasm_u16x8_lt(u8x16 a, u8x16 b)
static __inline__ u16x8 wasm_u16x8_lt(u16x8 a, u16x8 b) {
  return __extension__(u16x8){a < b};
}
...
static __inline__ u32x4 wasm_i32x4_lt(u32x4 a, u32x4 b) {
  return __extension__(u32x4){a < b};
}

//f32x4 wasm_f32x4_lt(f32x4 a, f32x4 b)
static __inline__ f32x4 wasm_f32x4_lt(f32x4 a, f32x4 b) {
  return __extension__(f32x4){a < b};
}

//f64x2 wasm_f64x2_lt(f64x2 a, f64x2 b)
static __inline__ f64x2 wasm_f64x2_lt(f64x2 a, f64x2 b) {
  return __extension__(f64x2){a < b};
}

//i8x16 wasm_i8x16_le(i8x16 a, i8x16 b)
static __inline__ i8x16 wasm_i16x8_le(i8x16 a, i8x16 b) {
  return __extension__(i8x16){a <= b};
}

//u8x16 wasm_i8x16_le(u8x16 a, u8x16 b)
static __inline__ u8x16 wasm_i16x8_le(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a <= b};
}
...
//u16x8 wasm_i16x8_le(u8x16 a, u8x16 b)
static __inline__ u8x16 wasm_u16x8_le(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a <= b};
}
...
static __inline__ u32x4 wasm_i32x4_le(u32x4 a, u32x4 b) {
  return __extension__(u32x4){a <= b};
}

//f32x4 wasm_f32x4_le(f32x4 a, f32x4 b)
static __inline__ f32x4 wasm_f32x4_le(f32x4 a, f32x4 b) {
  return __extension__(f32x4){a <= b};
}

//f64x2 wasm_f64x2_le(f64x2 a, f64x2 b)
static __inline__ f64x2 wasm_f64x2_le(f64x2 a, f64x2 b) {
  return __extension__(f64x2){a <= b};
}

//i8x16 wasm_i8x16_gt(i8x16 a, i8x16 b)
static __inline__ i8x16 wasm_i16x8_gt(i8x16 a, i8x16 b) {
  return __extension__(i8x16){a > b};
}

//u8x16 wasm_u8x16_gt(u8x16 a, u8x16 b)
static __inline__ u8x16 wasm_i16x8_gt(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a > b};
}
...
//u16x8 wasm_u16x8_gt(u8x16 a, u8x16 b)
static __inline__ u8x16 wasm_u16x8_gt(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a > b};
}
...
//u32x4 wasm_i32x4_gt(u32x4 a, u32x4 b)
static __inline__ u32x4 wasm_u32x4_gt(u32x4 a, u32x4 b) {
  return __extension__(u32x4){a > b};
}

//f32x4 wasm_f32x4_gt(f32x4 a, f32x4 b)
static __inline__ f32x4 wasm_f32x4_gt(f32x4 a, f32x4 b) {
  return __extension__(f32x4){a > b};
}

//f64x2 wasm_f64x2_gt(f64x2 a, f64x2 b)
static __inline__ f64x2 wasm_f64x2_gt(f64x2 a, f64x2 b) {
  return __extension__(f64x2){a > b};
}

//i8x16 wasm_i8x16_ge(i8x16 a, i8x16 b)
static __inline__ i8x16 wasm_i16x8_ge(i8x16 a, i8x16 b) {
  return __extension__(i8x16){a >= b};
}

//u8x16 wasm_u8x16_ge(u8x16 a, u8x16 b)
static __inline__ u8x16 wasm_i16x8_ge(u8x16 a, u8x16 b) {
  return __extension__(u8x16){a >= b};
}

//i16x8 wasm_i16x8_ge(i16x8 a, i16x8 b)
static __inline__ i16x8 wasm_i16x8_ge_s(i16x8 a, i16x8 b) {
  return __extension__(i16x8){a >= b};
}

//u16x8 wasm_i16x8_ge(u16x8 a, u16x8 b)
...
static __inline__ f32x4 wasm_f32x4_ge(f32x4 a, f32x4 b) {
  return __extension__(f32x4){a >= b};
}

//f64x2 wasm_f64x2_ge(f64x2 a, f64x2 b)
static __inline__ f64x2 wasm_f64x2_ge(f64x2 a, f64x2 b) {
  return __extension__(f32x4){a >= b};
}
...
#define wasm_convert_f32x4_i32x4(a, b) (__builtin_convertvector(a, b))
#define wasm_convert_f32x4_u32x4(f32x4, v) (__builtin_convertvector(v, f32x4))
#define wasm_convert_f64x2_i64x2(f64x2, v) (__builtin_convertvector(v, f64x2))
#define wasm_convert_f64x2_u64x2(f64x2, v) (__builtin_convertvector(v, f64x2))
